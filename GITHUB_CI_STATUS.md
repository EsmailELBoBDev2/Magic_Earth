# CairoDrive v22.3.1 GitHub CI status
...
- Google keys: intentionally tracked in `config/google_keys.env.example` and embedded into the build at user request
- GitHub Secrets: none required
- private Release input: not used
- trigger: push to `main` or manual workflow dispatch
- artifact: `CairoDrive-v22.3.1-DRIVE-TEST-com.cairodrive.app`
